...
const addComment = async (req, res) => {
    try {
        ...
        const populated = await Task.findById(task._id).populate('comments.userId', 'name avatar');
...
module.exports = { listTasks, createTask, getTask, updateTask, updateTaskStatus, addComment, deleteTask };
