...
import { termsSections } from '@/constants/translations';
        ...
        <View style={[styles.container, { backgroundColor: theme.bgCream }]}>
            ...
            <View style={[styles.headerBg, { paddingTop: insets.top, backgroundColor: theme.headerBg }]}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerTitle}>{t('terms_header')}</Text>
                    <View style={{ width: 32 }} />
                </View>
            </View>
            <ScrollView
            ...
            >
                <Text style={styles.lastUpdated}>{t('terms_last_updated')}</Text>
